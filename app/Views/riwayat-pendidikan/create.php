...
<div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <form action="/riwayat-pendidikan/store" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="mb-3">
                        <label for="nama_jenis_daftar" class="form-label">Nama Jenis Daftar</label>
                        <input type="text" class="form-control" id="nama_jenis_daftar" name="nama_jenis_daftar" 
                               value="<?= old('nama_jenis_daftar') ?>" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="keterangan_keluar" name="keterangan_keluar" 
                               value="<?= old('keterangan_keluar') ?>" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_perguruan_tinggi" name="nama_perguruan_tinggi" 
                               value="<?= old('nama_perguruan_tinggi') ?>" required>
                    </div>
