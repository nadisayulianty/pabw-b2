      ...
      <div class="row mt-4">
        ...
        <div class="card-body px-0 pt-0 pb-2">
            <div class="table-responsive p-0">
                <a href="<?= base_url('riwayat-pendidikan/create') ?>" class="btn bg-gradient-light">
                    Tambah Data
                </a>
                <table class="table bg-white table-hover align-items-center mb-0">
                    ...
                    <tbody>
                    <?php $no=1; foreach ($riwayat_pendidikan as $value): ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <p class="mb-0 text-sm"><?= $value['nim'] ?></p>
                        </td>
                        <td class="text-center">
                            <p class="mb-0 text-sm"><?= $value['nama_jenis_daftar'] ?></p>
                        </td>
                        <td class="text-center">
                            <p class="mb-0 text-sm"><?= $value['keterangan_keluar'] ?></p>
                        </td>
                        <td class="text-center">
                            <p class="mb-0 text-sm"><?= $value['nama_perguruan_tinggi'] ?></p>
                        </td>
                        <td class="text-center">
                        ...
                        <td class="text-center">
                        <a href="<?= base_url('riwayat-pendidikan/'. $value['id_mahasiswa'] . '/edit') ?>" class="btn bg-gradient-info btn-block">
                        Edit
                        </a>
                        <a href="#" data-href="<?= base_url('riwayat-pendidikan/' . $value['id_mahasiswa'] . '/delete') ?>" onclick="confirmToDelete(this)" class="btn bg-gradient-danger btn-block" data-bs-toggle="modal" data-bs-target="#confirm-dialog">Hapus</a>
                        </td>
                    </tr>
                    <?php $no++; endforeach ?>
                    </tbody>
