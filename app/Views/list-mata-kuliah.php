                                        ...
                                        <div class="modal-body p-0">
                                            <div class="card card-plain">
                                                <div class="card-header pb-0 text-left">
                                                    <h3 class="font-weight-bolder text-primary text-gradient">Tabel List Mata Kuliah</h3>
                                                ...
                                                <div class="card-body pb-3">
                                                    <form action="<?= base_url('table/list-mata-kuliah/new') ?>" method="post" role="form text-left">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" class="form-control" name="nama_mata_kuliah" placeholder="Nama Matakuliah" aria-describedby="email-addon">
                                                        </div>
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" class="form-control" name="nama_program_studi" placeholder="Jumlah mahasiswa KRS" aria-label="keterangan" aria-describedby="password-addon">
                                                        </div>
