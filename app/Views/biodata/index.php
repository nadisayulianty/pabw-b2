...
<main class="main-content position-relative border-radius-lg" style="height: 100dvh">
    <!-- Navbar -->
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Biodata Mahasiswa</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Biodata Mahasiswa</h6>
        </nav>
      ...
      <div class="row mt-4">
        ...
        <div class="card-body px-0 pt-0 pb-2">
            <div class="table-responsive p-0">
                <a href="<?= base_url('biodata-mahasiswa/create') ?>" class="btn bg-gradient-light">
                    Tambah Data
                </a>
                <table class="table bg-white table-hover align-items-center mb-0">
                    ...
                    <tr>
                        ...
                        <th class="text-center text-uppercase text-xxs font-weight-bolder">Jalan</th>
                    ...
                    <tbody>
                    <?php $no=1; foreach ($biodata as $value): ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <p class="mb-0 text-sm"><?= $value['tempat_lahir'] ?></p>
                        </td>
                        <td class="text-center">
                            <p class="mb-0 text-sm"><?= $value['jalan'] ?></p>
                        </td>
                        <td class="text-center">
                            <p class="mb-0 text-sm"><?= $value['kelurahan'] ?></p>
                        </td>
                        <td class="text-center">
                        ...
                        <td class="text-center">
                        <a href="<?= base_url('biodata-mahasiswa/'. $value['id_mahasiswa'] . '/edit') ?>" class="btn bg-gradient-info btn-block">
                        Edit
                        </a>
                        <a href="#" data-href="<?= base_url('biodata-mahasiswa/' . $value['id_mahasiswa'] . '/delete') ?>" onclick="confirmToDelete(this)" class="btn bg-gradient-danger btn-block" data-bs-toggle="modal" data-bs-target="#confirm-dialog">Hapus</a>
                        </td>
                    </tr>
                    <?php $no++; endforeach ?>
                    </tbody>
