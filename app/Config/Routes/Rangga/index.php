...
$routes->get('tableriwayatpangkatdosen', 'TableRiwayatPangkatDosen::index');
    ...
    $routes->get('tableriwayatpangkatdosen/cari', 'TableRiwayatPangkatDosen::cari');
    ...
    $routes->get('tableriwayatsertifikasidosen/cari', 'TableRiwayatSertifikasiDosen::cari');
    ...
    $routes->get('tablelistanggotaaktivitasmahasiswa/cari', 'TableListAnggotaAktivitasMahasiswa::cari');